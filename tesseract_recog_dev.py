...
class Process():
    ...
    def get_code(self):
        ...
        self.gt = os.path.split(path)[-1].split('.')[0]
        self.check_char(img)

        print(self.gt, self.code, self.gt == self.code)
    ...
    def get_category(self):
        ...
        self.category = self.category_dict[category] if category in self.category_dict else None
        #print(self.category)
        print(category)
